...
const ArticleCard = ({ article, isStudent = false }) => {
  const getCategoryColor = (category) => {
    const colors = {
      'Science': 'bg-green-500/40 text-green-400 border-green-500/30',
      'Math': 'bg-blue-500/40 text-blue-400 border-blue-500/30',
      'English': 'bg-purple-500/40 text-purple-400 border-purple-500/30',
      'History': 'bg-amber-500/40 text-amber-400 border-amber-500/30',
      'Geography': 'bg-emerald-500/40 text-emerald-400 border-emerald-500/30',
      'Art': 'bg-pink-500/40 text-pink-400 border-pink-500/30',
      'Technology': 'bg-indigo-500/40 text-indigo-400 border-indigo-500/30',
    };
